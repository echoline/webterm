...
function dirent(f) {
	var s = {"type":0, "dev":0, "qid": pack(f.qid, Qid), "mode": 0, "atime":0, "mtime":0, "length":0, "name":f.name, "uid":"js", "gid":"js", "muid":"js"};
...
function readstr(p, n) {
	return send9p({type: msgtype.Rread, tag: p.tag, data: n.substring(p.offset, p.offset+p.count)})
}
