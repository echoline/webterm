...
"echo -n hangup >/proc/$pid/notepg\n";
				...
				document.getElementById('buttons').innerHTML = '<input type="button" value="new window" onclick="javascript:term.consbuf += \'hwin\'; term.addchar(13);"><input type="button" style="float:right;" value="log out" onclick="javascript:conn.close();">';
				break;
			default:
