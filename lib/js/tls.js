...
"rc -c 'echo -n > /dev/audio' >[2]/dev/null\n" +
"echo -n hangup >/proc/$pid/notepg\n";
				tlswrite("" + script.length + "\n" + script);
				document.getElementById('buttons').innerHTML = '<input type="button" value="new window" onclick="javascript:term.consbuf += \'hwin\'; term.addchar(13);"><input type="button" style="float:right;" value="log out" onclick="javascript:logout();">';
				break;
			default:
